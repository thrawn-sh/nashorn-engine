...
abstract class NashornLoader extends SecureClassLoader {
    private static final String OBJECTS_PKG        = "de.shadowhunt.javascript.nashorn.internal.objects";
    private static final String RUNTIME_PKG        = "de.shadowhunt.javascript.nashorn.internal.runtime";
    private static final String RUNTIME_ARRAYS_PKG = "de.shadowhunt.javascript.nashorn.internal.runtime.arrays";
    private static final String RUNTIME_LINKER_PKG = "de.shadowhunt.javascript.nashorn.internal.runtime.linker";
    private static final String SCRIPTS_PKG        = "de.shadowhunt.javascript.nashorn.internal.scripts";
