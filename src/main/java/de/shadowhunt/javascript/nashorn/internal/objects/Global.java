...
import static de.shadowhunt.javascript.nashorn.internal.lookup.Lookup.MH;
import static de.shadowhunt.javascript.nashorn.internal.runtime.ECMAErrors.referenceError;
import static de.shadowhunt.javascript.nashorn.internal.runtime.ECMAErrors.typeError;
import static de.shadowhunt.javascript.nashorn.internal.runtime.JSType.isString;
import static de.shadowhunt.javascript.nashorn.internal.runtime.ScriptRuntime.UNDEFINED;
...
import de.shadowhunt.javascript.internal.dynalink.CallSiteDescriptor;
import de.shadowhunt.javascript.internal.dynalink.linker.GuardedInvocation;
import de.shadowhunt.javascript.internal.dynalink.linker.LinkRequest;
import de.shadowhunt.javascript.nashorn.api.scripting.ClassFilter;
import de.shadowhunt.javascript.nashorn.api.scripting.ScriptObjectMirror;
import de.shadowhunt.javascript.nashorn.internal.lookup.Lookup;
import de.shadowhunt.javascript.nashorn.internal.objects.annotations.Attribute;
import de.shadowhunt.javascript.nashorn.internal.objects.annotations.Getter;
...
import de.shadowhunt.javascript.nashorn.internal.objects.annotations.Setter;
...
import de.shadowhunt.javascript.nashorn.internal.runtime.FindProperty;
import de.shadowhunt.javascript.nashorn.internal.runtime.GlobalConstants;
import de.shadowhunt.javascript.nashorn.internal.runtime.GlobalFunctions;
import de.shadowhunt.javascript.nashorn.internal.runtime.JSType;
import de.shadowhunt.javascript.nashorn.internal.runtime.NativeJavaPackage;
import de.shadowhunt.javascript.nashorn.internal.runtime.PropertyDescriptor;
...
import de.shadowhunt.javascript.nashorn.internal.runtime.Specialization;
import de.shadowhunt.javascript.nashorn.internal.runtime.arrays.ArrayData;
import de.shadowhunt.javascript.nashorn.internal.runtime.linker.Bootstrap;
import de.shadowhunt.javascript.nashorn.internal.runtime.linker.InvokeByName;
import de.shadowhunt.javascript.nashorn.internal.runtime.linker.NashornCallSiteDescriptor;
import de.shadowhunt.javascript.nashorn.internal.runtime.regexp.RegExpResult;
import de.shadowhunt.javascript.nashorn.internal.scripts.JD;
import de.shadowhunt.javascript.nashorn.internal.scripts.JO;
import de.shadowhunt.javascript.nashorn.tools.ShellFunctions;
...
public final class Global extends Scope {
    ...
    @Override
    public void addBoundProperties(final ScriptObject source, final de.shadowhunt.javascript.nashorn.internal.runtime.Property[] properties) {
        ...
        if (context.getEnv()._es6) {
            ...
            for (final de.shadowhunt.javascript.nashorn.internal.runtime.Property property : properties) {
                if (property.isLexicalBinding()) {
                    hasLexicalDefinitions = true;
                }
                // ES6 15.1.8 steps 6. and 7.
                final de.shadowhunt.javascript.nashorn.internal.runtime.Property globalProperty = ownMap.findProperty(property.getKey());
                ...
                final de.shadowhunt.javascript.nashorn.internal.runtime.Property lexicalProperty = lexicalMap.findProperty(property.getKey());
    ...
    private <T extends ScriptObject> T initConstructor(final String name, final Class<T> clazz) {
        try {
            ...
            final StringBuilder sb = new StringBuilder("de.shadowhunt.javascript.nashorn.internal.objects.");
    ...
    private List<de.shadowhunt.javascript.nashorn.internal.runtime.Property> extractBuiltinProperties(final String name, final ScriptObject func) {
        final List<de.shadowhunt.javascript.nashorn.internal.runtime.Property> list = new ArrayList<>();
        ...
        final de.shadowhunt.javascript.nashorn.internal.runtime.Property prop = getProperty(name);
        if (prop != null) {
            list.add(prop);
        }
    ...
    private void tagBuiltinProperties(final String name, final ScriptObject func) {
        ...
        for (final de.shadowhunt.javascript.nashorn.internal.runtime.Property prop : extractBuiltinProperties(name, func)) {
    ...
    private void initFunctionAndObject() {
        ...
        de.shadowhunt.javascript.nashorn.internal.runtime.Property[] properties = getFunctionPrototype().getMap().getProperties();
        for (final de.shadowhunt.javascript.nashorn.internal.runtime.Property property : properties) {
        ...
        for (final de.shadowhunt.javascript.nashorn.internal.runtime.Property property : builtinObject.getMap().getProperties()) {
            final Object key = property.getKey();
    ...
    private static class LexicalScope extends ScriptObject {
        ...
        @Override
        protected PropertyMap addBoundProperty(final PropertyMap propMap, final ScriptObject source, final de.shadowhunt.javascript.nashorn.internal.runtime.Property property, final boolean extensible) {
